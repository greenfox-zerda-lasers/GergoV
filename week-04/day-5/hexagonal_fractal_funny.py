...
def hexagonal_fractal(x, y, a):
    ...
    if a > 5:
        a = a/3
        hexagonal_fractal(x, y, a)
        hexagonal_fractal(x + 2*(a), y, a)
        hexagonal_fractal(x + 3 * a, y + 2 * a * h, a)
        hexagonal_fractal(x + 2*(a), y + 2* 2 * a * h, a)
        hexagonal_fractal(x, y + 2* 2 * a * h, a)
        hexagonal_fractal(x - a/2, 2 * a * h, a)
